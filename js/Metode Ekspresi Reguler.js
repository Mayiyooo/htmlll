...
hasIndices	Returns true if the d modifier is set in the expression
(new in 2022)
...
unicode	Returns true if the u modifier is set in the expression
(new in 2018)
unicodeSets	Returns true if the v modifier is set in the expression
(new in 2023)